	...
	return (
		<>
			<article
				...
				className="flex flex-col gap-8 w-xl border-2 border-gray-200 rounded-lg p-6 mx-auto my-10 bg-white shadow-md"
			>
				{/* ---------- Cabecera ---------- */}
				<header className="space-y-2">
					<p className="text-xl font-semibold">👷 ¿Qué servicio necesitas?‍</p>
